...
function SmartWizard(target, options) {
    ...
    this.buttons = {
        ...
        next: $('<button type="button">' + options.labelNext + '</button>').attr("id","_nextBtn").addClass("buttonNext"),
        //previous : $('<a>'+options.labelPrevious+'</a>').attr("href","#").addClass("buttonPrevious"),
        previous: $('<button type="submit">' + options.labelPrevious + '</button>').addClass("buttonPrevious"),
